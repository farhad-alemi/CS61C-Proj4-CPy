...
class TestAdd(TestCase):
    ...
    def test_large_add(self):
        # YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(12000, 12001, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(12000, 12001, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "add")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestAbs(TestCase):
    ...
    def test_large_abs(self):
        # YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(10000, 10001, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestNeg(TestCase):
    ...
    def test_large_neg(self):
        # YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(9865, 11156, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
